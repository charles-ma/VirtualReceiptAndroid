...
/**
 * An abstract helper class for the charts to extend. It contains some methods for
...
public abstract class MyChartHelper implements MyChartInterface {
  ...
  protected List<Integer> getUniqueColors(int amount) {
	...
	int[] colors = new int[] { Color.BLUE, Color.GREEN, Color.MAGENTA, Color.YELLOW, Color.CYAN, Color.LTGRAY, Color.RED, Color.DKGRAY,
